...
const slides = [
  {
    ...
    description:
      "Más de 8 años de experiencia garantizando espacios limpios y seguros",
    image: "/assets/industrial-cleaning-professional-team.jpg",
  },
  {
    title: "Tratamiento de Agua",
    description:
      "Soluciones integrales para el tratamiento y purificación de agua",
        ...
        >
          ...
          <div className="relative h-full container mx-auto px-4 md:px-6 lg:px-8 flex items-center">
            <div className="max-w-2xl text-background">
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-3 md:mb-4 text-balance leading-tight">
                {slide.title}
              </h1>
              <p className="text-base md:text-lg lg:text-xl mb-6 text-background/95 max-w-xl">
                {slide.description}
              </p>
